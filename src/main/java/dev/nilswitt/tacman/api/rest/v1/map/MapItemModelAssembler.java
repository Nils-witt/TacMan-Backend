...
@Component
public class MapItemModelAssembler
  implements RepresentationModelAssembler<MapItemDto, EntityModel<MapItemDto>>
{
  ...
  public EntityModel<MapItemDto> toModel(MapItemDto mapItem) {
    return EntityModel.of(
      ...
      WebMvcLinkBuilder.linkTo(
        methodOn(MapItemController.class).one(mapItem.getId(), null)
      ).withSelfRel(),
