...
class MapOverlayControllerTests {
    ...
    void shouldCreateOverlay() throws Exception {
        ...
        // cleanup
        mockMvc
                .perform(delete("/api/map/overlays/" + id))
                .andExpect(status().isOk());
    }
    ...
    void shouldReturn404ForNonExistentOverlay() throws Exception {
        ...
        mockMvc
                .perform(get("/api/map/overlays/" + randomId))
                .andExpect(status().isNotFound());
        ...
        mockMvc
                .perform(delete("/api/map/overlays/" + randomId))
                .andExpect(status().isNotFound());
    }
}
